...
import useSizeColumn from './columns';
...
export function DataTable<TData>({ data, meta }: DataTableProps<TData>) {
  const { getColumns } = useSizeColumn();
    ...
    <div className="container z-10">
      <div className="mt-5">
        <div className="flex justify-between">
          <div>
            <h2 className="font-bold text-2xl">Sizes ({meta.totalItems})</h2>
            <span>Manage sizes for your store's products.</span>
          </div>
          <AuthRender role="ADMIN">
            <Button asChild variant={'default'}>
              <Link href={'/size/create'}>
