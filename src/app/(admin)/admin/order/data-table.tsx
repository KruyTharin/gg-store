...
import useOrderColumn from './columns';
...
export function DataTable<TData>({ data, meta }: DataTableProps<TData>) {
  const { getColumns } = useOrderColumn();
    ...
    <div className="container z-10">
      <div className="mt-5">
        <div className="flex justify-between">
          <div>
            <h2 className="font-bold text-2xl">Orders ({meta.totalItems})</h2>
            <span>The list of your order</span>
          </div>
        </div>
